...
public class Dependencies<T> {
    ...
    private Dependencies(top.hendrixshen.magiclib.dependency.api.annotation.@NotNull Dependencies dependencies, Class<T> clazz) {
    ...
    private static <T> boolean testHelper(@NotNull Predicate<T> l, Object obj) {
        return l.isSatisfied((T) obj);
    }

    @Contract("_, _ -> new")
    public static <T> @NotNull Dependencies<T> of(top.hendrixshen.magiclib.dependency.api.annotation.Dependencies dependencies, Class<T> clazz) {
    ...
    @Contract("_, _ -> new")
    public static <T> @NotNull Dependencies<T> of(AnnotationNode dependencyAnnotation, Class<T> clazz) {
    ...
    private static List<Dependency> generateRequirement(top.hendrixshen.magiclib.dependency.api.annotation.Dependency[] dependencies) {
    ...
    private static @NotNull List<Dependency> getDependencyList(AnnotationNode annotationNode, String key) {
