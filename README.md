...
If you use agent coding, please instruct your agents to follow the agents.md we provide so the agent can better understand our project.

All AI-generated content must be human-reviewed. Additionally, you **must** clearly inform us what agent and LLM you used. If you do not agree to this, **please do not** contribute code to us that was generated by AI.
