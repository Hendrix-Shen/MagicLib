...
public class ClientItemArgument implements ArgumentType<ItemInput> {
    ...
    public ItemInput parse(StringReader stringReader) throws CommandSyntaxException {
        return net.minecraft.commands.arguments.item.ItemArgument.item().parse(stringReader);
    }

    @Override
    public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> context, SuggestionsBuilder builder) {
        return net.minecraft.commands.arguments.item.ItemArgument.item().listSuggestions(context, builder);
    }
