...
public class ClientScoreHolderArgument implements ArgumentType<ClientScoreHolderArgument.Result> {
     ...
     */
    public static String getName(CommandContext<ClientCommandSource> context, String name) throws CommandSyntaxException {
     ...
     * @throws CommandSyntaxException if no score holder matches
     */
    public static Collection<String> getNames(CommandContext<ClientCommandSource> context, String name) throws CommandSyntaxException {
     ...
     * @throws CommandSyntaxException if no score holder matches
     */
    public static Collection<String> getNamesWithDefaultWildcard(CommandContext<ClientCommandSource> context, String name) throws CommandSyntaxException {
    ...
    public static Collection<String> getNames(
        ...
        Collection<String> collection = context.<ClientScoreHolderArgument.Result>getArgument(name, ClientScoreHolderArgument.Result.class)
    ...
    public ClientScoreHolderArgument.Result parse(StringReader stringReader) throws CommandSyntaxException {
        ...
        return (source, supplier) -> collection;
    }
    ...
    public interface Result {
         ...
         * @throws CommandSyntaxException if no score holder matches
         */
        Collection<String> getNames(ClientCommandSource source, Supplier<Collection<String>> supplier) throws CommandSyntaxException;
    }
    ...
    static class SelectorResult implements ClientScoreHolderArgument.Result {
        ...
        @Override
        public Collection<String> getNames(ClientCommandSource source, Supplier<Collection<String>> supplier) throws CommandSyntaxException {
