...
public class ClientParticleArgument implements ArgumentType<ParticleOptions> {
    ...
    public ParticleOptions parse(StringReader reader) throws CommandSyntaxException {
        return ParticleArgument.readParticle(reader,
                ClientBlockStateArgument.getBuildContext().holderLookup(Registries.PARTICLE_TYPE));
    }
    ...
    public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> context, SuggestionsBuilder builder) {
        return SharedSuggestionProvider.suggestResource(BuiltInRegistries.PARTICLE_TYPE.keySet(), builder);
    }
